<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add118.aspx.cs" Inherits="Add118" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="subLabel">
            ...
            <asp:Label ID="Label1" runat="server" Text="ADD / DELETE DATA"></asp:Label>
            ...
            <asp:GridView ID="gvUsers" runat="server" CellPadding="4" ForeColor="Black" GridLines="None" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="COURSE">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtTermNo" Text='<%# Eval("Course") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                    ...
                    <asp:TemplateField HeaderText="COURSE TITLE">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtTermNo" Text='<%# Eval("CourseTitle") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                    ...
                    <asp:TemplateField HeaderText="UNITS">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtTermNo" Text='<%# Eval("Units") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                    ...
                    <asp:TemplateField HeaderText="SOFT">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtTermNo" Text='<%# Eval("SoftReq") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                    ...
                    <asp:TemplateField HeaderText="CO">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtTermNo" Text='<%# Eval("CoReq") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                    ...
                    <asp:TemplateField HeaderText="HARD">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtTermNo" Text='<%# Eval("HardReq") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
